...
class SalesGenerator:
    def __init__(self, stores, products, random_seed=42):
        """
        ...
        for date in tqdm(date_range, desc="Generating sales data"):
            for store in self.stores:
                ...
                if store.city == 'Hanoi':
                    ...
                    category_factors = {'Electronics': 1.5, 'Clothing': 1.3, 'Home Goods': 0.9, 'Food': 1.0, 'Beauty': 0.8}
                elif store.city == 'Da Nang':
                    # Higher home goods and beauty sales
                    category_factors = {'Electronics': 0.9, 'Clothing': 1.0, 'Home Goods': 1.4, 'Food': 1.1, 'Beauty': 1.3}
                else:  # Ho Chi Minh City
                    # Higher food and electronics sales
                    category_factors = {'Electronics': 1.3, 'Clothing': 1.1, 'Home Goods': 1.0, 'Food': 1.5, 'Beauty': 1.2}
                ...
                for product in products_sold:
                    ...
                    adjusted_quantity = int(base_quantity * category_factors[product.category] * city_factor)
...
if __name__ == "__main__":
    ...
    sales_df = generator.generate_sales_data(30, "data/sales_data.csv")  # 30 days of data
